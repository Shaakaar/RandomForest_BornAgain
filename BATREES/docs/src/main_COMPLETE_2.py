...
#  Graphviz: download on https://graphviz.org/download/ ->
...
PARTIAL_CSV_PATH_2 = "aggregated_results_partial_MEAN.csv"
...
def run_born_again(objectives, datasets, folds, n_trees, tree_depth, 
                   ...
                   PARTIAL_CSV_PATH,
                   PARTIAL_CSV_PATH_2  # path for partial saving
                  ):
    """
                        ...
                        for depth_val in tree_depth:
                            ...
                            if ret.returncode != 0:
                                ...
                                if not os.path.exists(treefile):
                                    ...
                                    ba_depth       = unpruned_clf.tree_.max_depth
                                    ...
                                    p_depth       = pruned_clf.tree_.max_depth 
